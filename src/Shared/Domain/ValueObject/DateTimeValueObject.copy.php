...
class DateTimeValueObjectCopy extends \DateTimeImmutable implements ValueObjectInterface
{
    private function __construct(protected readonly string $dateTime = '')
    {
